	...
	tables: [
		tableSchema({
			...
			columns: [
				...
				{ name: 'u', type: 'string', optional: true },
				{ name: 'f', type: 'boolean' },
				...
				{ name: 'cardId', type: 'string', isIndexed: true },
				...
				{ name: 'adhoc', type: 'boolean', optional: true },
				{ name: 'isOwner', type: 'boolean', optional: true },
		...
		tableSchema({
			...
			columns: [
				...
				{ name: '_updatedAt', type: 'number', isOptional: true },
				{ name: 'active', type: 'boolean' },
				{ name: 'avatarOrigin', type: 'string' },
				{ name: 'blocks', type: 'string' },
				{ name: 'CreatedAt', type: 'number', isOptional: true },
				{ name: 'imageOrigin', type: 'string' },
				{ name: 'name', type: 'string' },
				{ name: 'order', type: 'number' },
				{ name: 'scene', type: 'string' },
				{ name: 'userId', type: 'string' },
				{ name: 'username', type: 'string' },
				{ name: 'isSecret', type: 'boolean', isOptional: true },
				{ name: 'back_color', type: 'string', isOptional: true },
				{ name: 'text_color', type: 'string', isOptional: true },
				{ name: 'avatar_etag', type: 'string', isOptional: true },
				{ name: 'disabled_option', type: 'string', isOptional: true }
			]
		}),
		tableSchema({
			name: 'rooms',
		...
		tableSchema({
			...
			columns: [
				...
				{ name: 'rid', type: 'string', isIndexed: true },
				{ name: 'cardId', type: 'string', isOptional: true },
				{ name: 'ts', type: 'number' },
				{ name: 'u', type: 'string' },
				{ name: 'c', type: 'string' },
		...
		tableSchema({
			...
			columns: [
				...
				{ name: 'ts', type: 'number' },
				{ name: 'u', type: 'string' },
				{ name: 'c', type: 'string', isOptional: true },
				{ name: 'cardId', type: 'string', isOptional: true },
