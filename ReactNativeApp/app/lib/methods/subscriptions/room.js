...
export default class RoomSubscription {
	...
	handleConnection = () => {
		reduxStore.dispatch(clearUserTyping());
		RocketChat.loadMissedMessages({ rid: this.rid, cardId: this.cardId }).catch(e => console.log(e));
	};
	...
	read = debounce((lastOpen) => {
		RocketChat.readMessages(this.rid, this.cardId, lastOpen);
	}, 300);
