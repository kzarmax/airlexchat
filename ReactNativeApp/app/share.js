...
// Outside Stack
import OutsideShareView from './views/OutsideShareView';

// Inside Stack
import ShareListView from './views/ShareListView';
import OpenSecretCardView from './views/OpenSecretCardView';
import ShareSidebarView from './views/ShareSidebarView';
...
const InsideStack = () => {
	...
	return (
		<Inside.Navigator screenOptions={screenOptions}>
			...
			/>
			<Inside.Screen
				name='ShareSidebarView'
				component={ShareSidebarView}
				options={ShareSidebarView.navigationOptions}
			/>
		</Inside.Navigator>
	);
};
...
const OutsideStack = () => {
	...
	return (
		<Outside.Navigator screenOptions={{ ...defaultHeader, ...themedHeader(theme) }}>
			<Outside.Screen
				name='OutsideShareView'
				component={OutsideShareView}
				options={OutsideShareView.navigationOptions}
			/>
		</Outside.Navigator>
	);
};
