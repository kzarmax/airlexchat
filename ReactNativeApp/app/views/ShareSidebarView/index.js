...
class ShareSidebar extends Component {
	static navigationOptions = () => {
		return {
			...
			headerTitle:() => <Text style={styles.headerText}>{I18n.t('Side_Bar')}</Text>,
		};
	};
...
export default connect(mapStateToProps, mapDispatchToProps)(withTheme(ShareSidebar));
