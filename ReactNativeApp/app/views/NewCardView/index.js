...
class NewCardView extends React.Component {
	...
	nextView = () => {
		...
		navigation.navigate('NewCardProfileView', this.state);
	}
...
export default connect(mapStateToProps, mapDispatchToProps)(withTheme(NewCardView));
