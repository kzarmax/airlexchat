...
import { IAuthorization, RoomAccessValidator, RoomAccessWithUserValidator } from '../../sdk/types/IAuthorization';
...
import { canAccessRoomWithUser } from './canAccessRoomWithUser';
...
export class Authorization extends ServiceClass implements IAuthorization {
	...
	async canAccessRoomWithUser(...args: Parameters<RoomAccessWithUserValidator>): Promise<boolean> {
		return canAccessRoomWithUser(...args);
	}
