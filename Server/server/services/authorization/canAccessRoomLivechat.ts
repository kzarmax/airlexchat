...
export const canAccessRoomLivechat: RoomAccessValidator = async (room, card, extraData): Promise<boolean> => {
	...
	return AuthorizationLivechat.canAccessRoom(livechatRoom, card, extraData);
};
