...
registerAdminRoute('/point-profile/:context?/:id?', {
	name: 'point-profile',
	lazyRouteComponent: () => import('./pointProfile/PointProfileRoute'),
});
...
registerAdminRoute('/cards/:context?/:id?', {
	name: 'admin-cards',
	lazyRouteComponent: () => import('./cards/CardsRoute'),
});
