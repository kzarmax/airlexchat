...
const EditCustomEmojiWithData: FC<EditCustomEmojiWithDataProps> = ({ _id, categories, onChange, ...props }) => {
	...
	return <EditCustomEmoji data={data.emojis.update[0]} categories={categories} onChange={handleChange} {...props}/>;
};
