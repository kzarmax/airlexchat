...
const UsageSection = React.memo(function UsageSection({ statistics, isLoading }) {
	...
	>
		...
		<DescriptionList.Entry label={t('Stats_IOS_App_Users')}>{s(() => statistics.iosAppUsers)}</DescriptionList.Entry>
		<DescriptionList.Entry label={t('Stats_Android_App_Users')}>{s(() => statistics.androidAppUsers)}</DescriptionList.Entry>
