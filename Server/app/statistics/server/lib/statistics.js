...
export const statistics = {
	get: function _getStatistics() {
		...
		statistics.appUsers = Users.find({ deviceInfo: { $ne: null }}).count();
		statistics.iosAppUsers = Users.find({ deviceInfo: `${settings.get('App_ReactNative_iOS_Version')}.${settings.get('App_ReactNative_iOS_Build')}`}).count();
		statistics.androidAppUsers = Users.find({ deviceInfo: `${settings.get('App_ReactNative_Android_Version')}.${settings.get('App_ReactNative_Android_Build')}`}).count();
