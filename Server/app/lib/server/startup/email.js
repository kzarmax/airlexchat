...
settings.addGroup('Email', function() {
	...
	this.section('Verification', function() {
		...
		this.add('Verification_Email', '<h2>{Welcome_to Site_Name}</h2><p>{Verification_email_body}</p><a class="btn" target="_blank" href="[Verification_Url]">{Verify_your_email}</a>', {
			type: 'code',
			code: 'text/html',
			multiline: true,
			i18nLabel: 'Body',
