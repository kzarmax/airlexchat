...
settings.addGroup('OAuth', function() {
	this.section('Apple', function() {
		...
		this.add('Accounts_OAuth_Apple_team_id', '', {
			type: 'string',
			enableQuery,
		});
		this.add('Accounts_OAuth_Apple_id', '', {
			type: 'string',
			enableQuery,
		});
		this.add('Accounts_OAuth_Apple_secret', '', {
			type: 'string',
			multiline: true,
			enableQuery,
			secret: true,
		});
		this.add('Accounts_OAuth_Apple_key_id', '', {
			type: 'string',
			enableQuery,
		});
		return this.add('Accounts_OAuth_Apple_callback_url', '_oauth/apple', {
			type: 'relativeUrl',
			readonly: true,
			force: true,
			enableQuery,
...
settings.addGroup('General', function() {
	...
	this.add('Allow_Distribute_Server', false, {
		type: 'boolean',
		secret: true,
	});
	this.add('Server_Urls', typeof __meteor_runtime_config__ !== 'undefined' && __meteor_runtime_config__ !== null ? __meteor_runtime_config__.ROOT_URL : null, {
		type: 'string',
		i18nDescription: 'Server_Urls_Description',
		private: true,
	});
	this.add('Site_Name', 'エアレペルソナ', {
		type: 'string',
		public: true,
		wizard: {
			step: 3,
...
settings.addGroup('Layout', function() {
	this.section('Content', function() {
		...
		this.add('Layout_Faq', 'Faq <br> Go to APP SETTINGS &rarr; Layout to customize this page.', {
			type: 'code',
			code: 'text/html',
			multiline: true,
			public: true,
...
settings.addGroup('Payment', function() {
	this.section('Stripe', function () {
		this.add('Stripe_Enabled', true, {type: 'boolean'});
		this.add('Stripe_Publishable_key', '', {
			type: 'string',
			enableQuery: {_id: 'Stripe_Enabled', value: true}
		});
		this.add('Stripe_Secret_key', '', {
			type: 'string',
			enableQuery: {_id: 'Stripe_Enabled', value: true}
		});
	});
	// this.section('Apple_Pay', function () {
	// 	this.add('Apple_Pay_key', '', {
	// 		type: 'string',
	// 		multiline: true,
	// 		secret: true,
	// 	});
	// 	this.add('Apple_Pay_cert', '', {
	// 		type: 'string',
	// 		multiline: true,
	// 		secret: true,
	// 	});
...
settings.addGroup('Versions', function() {
	this.add('App_Desktop_Version', '1.0.0', {
		type: 'string',
		public: true,
	});
	this.add('App_ReactNative_iOS_Version', '1.0.0', {
		type: 'string',
		public: true,
	});
	this.add('App_ReactNative_iOS_Build', '1', {
		type: 'string',
		public: true,
	});
	this.add('App_ReactNative_Android_Version', '1.0.0', {
		type: 'string',
		public: true,
	});
	this.add('App_ReactNative_Android_Build', '1', {
		type: 'string',
		public: true,
	});
});
