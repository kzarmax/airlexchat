...
API.v1.addRoute('info', { authRequired: false }, {
	get() {
		...
		const versions = {
			desktop: settings.get('App_Desktop_Version'),
			ios: settings.get('App_ReactNative_iOS_Build'),
			android: settings.get('App_ReactNative_Android_Build'),
			reactnative_ios: settings.get('App_ReactNative_iOS_Version'),
			reactnative_android: settings.get('App_ReactNative_Android_Version'),
		};
