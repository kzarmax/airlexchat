...
API.v1.addRoute('channels.rename', { authRequired: true }, {
	post() {
		...
		Meteor.runAsUser(this.userId, () => {
			Meteor.call('saveRoomSettings', findResult._id, this.bodyParams.cardId, 'roomName', this.bodyParams.name);
		});
...
API.v1.addRoute('channels.setCustomFields', { authRequired: true }, {
	post() {
		...
		Meteor.runAsUser(this.userId, () => {
			Meteor.call('saveRoomSettings', findResult._id, this.bodyParams.cardId, 'roomCustomFields', this.bodyParams.customFields);
		});
...
API.v1.addRoute('channels.setDefault', { authRequired: true }, {
	post() {
		...
		Meteor.runAsUser(this.userId, () => {
			Meteor.call('saveRoomSettings', findResult._id, this.bodyParams.cardId, 'default', ['true', '1'].includes(this.bodyParams.default.toString().toLowerCase()));
		});
...
API.v1.addRoute('channels.setDescription', { authRequired: true }, {
	post() {
		...
		Meteor.runAsUser(this.userId, () => {
			Meteor.call('saveRoomSettings', findResult._id, this.bodyParams.cardId, 'roomDescription', this.bodyParams.description);
		});
...
API.v1.addRoute('channels.setJoinCode', { authRequired: true }, {
	post() {
		...
		Meteor.runAsUser(this.userId, () => {
			Meteor.call('saveRoomSettings', findResult._id, this.bodyParams.cardId, 'joinCode', this.bodyParams.joinCode);
		});
...
API.v1.addRoute('channels.setPurpose', { authRequired: true }, {
	post() {
		...
		Meteor.runAsUser(this.userId, () => {
			Meteor.call('saveRoomSettings', findResult._id, this.bodyParams.cardId, 'roomDescription', this.bodyParams.purpose);
		});
...
API.v1.addRoute('channels.setReadOnly', { authRequired: true }, {
	post() {
		...
		Meteor.runAsUser(this.userId, () => {
			Meteor.call('saveRoomSettings', findResult._id, this.bodyParams.cardId, 'readOnly', this.bodyParams.readOnly);
		});
...
API.v1.addRoute('channels.setTopic', { authRequired: true }, {
	post() {
		...
		Meteor.runAsUser(this.userId, () => {
			Meteor.call('saveRoomSettings', findResult._id, this.bodyParams.cardId, 'roomTopic', this.bodyParams.topic);
		});
...
API.v1.addRoute('channels.setAnnouncement', { authRequired: true }, {
	post() {
		...
		Meteor.runAsUser(this.userId, () => {
			Meteor.call('saveRoomSettings', findResult._id, this.bodyParams.cardId, 'roomAnnouncement', this.bodyParams.announcement);
		});
...
API.v1.addRoute('channels.setType', { authRequired: true }, {
	post() {
		...
		Meteor.runAsUser(this.userId, () => {
			Meteor.call('saveRoomSettings', findResult._id, this.bodyParams.cardId, 'roomType', this.bodyParams.type);
		});
