...
import PointProfileModel from '../models/PointProfile';
import { PointProfileRaw } from './PointProfile';
import PointPurchaseHistoryModel from '../models/PointPurchaseHistory';
import { PointPurchaseHistoryRaw } from "./PointPurchaseHistory";
...
export const Cards = new CardsRaw(CardsModel.model.rawCollection(), trashCollection);
...
export const PointProfile = new PointProfileRaw(PointProfileModel.model.rawCollection(), trashCollection);
export const PointPurchaseHistory = new PointPurchaseHistoryRaw(PointPurchaseHistoryModel.model.rawCollection(), trashCollection);
