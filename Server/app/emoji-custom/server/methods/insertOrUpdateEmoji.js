...
Meteor.methods({
	insertOrUpdateEmoji(emojiData) {
		...
		if (emojiData.parent !== undefined){
			EmojiCustom.setParent(emojiData._id, emojiData.parent);
		}

		if (emojiData.points !== undefined) {
			EmojiCustom.setPoints(emojiData._id, emojiData.points);
		}
