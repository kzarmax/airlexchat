...
settings.addGroup('FileUpload', function() {
	...
	this.section('Amazon S3', function() {
		...
		this.add('FileUpload_S3_Proxy_CardImages', false, {
			type: 'boolean',
			enableQuery: {
				_id: 'FileUpload_Storage_Type',
				value: 'AmazonS3',
		...
		this.add('FileUpload_S3_Proxy_GroupImages', false, {
			type: 'boolean',
			enableQuery: {
				_id: 'FileUpload_Storage_Type',
				value: 'AmazonS3',
	...
	this.section('Google Cloud Storage', function() {
		...
		this.add('FileUpload_GoogleStorage_Proxy_CardImages', false, {
			type: 'boolean',
			enableQuery: {
				_id: 'FileUpload_Storage_Type',
				value: 'GoogleCloudStorage',
		...
		this.add('FileUpload_GoogleStorage_Proxy_GroupImages', false, {
			type: 'boolean',
			enableQuery: {
				_id: 'FileUpload_Storage_Type',
				value: 'GoogleCloudStorage',
	...
	this.section('WebDAV', function() {
		...
		this.add('FileUpload_Webdav_Proxy_CardImages', false, {
			type: 'boolean',
			enableQuery: {
				_id: 'FileUpload_Storage_Type',
				value: 'Webdav',
		...
		this.add('FileUpload_Webdav_Proxy_GroupImages', false, {
			type: 'boolean',
			enableQuery: {
				_id: 'FileUpload_Storage_Type',
				value: 'Webdav',
