...
FileUpload.configureUploadsStore('GridFS', 'GridFS:CardImages', {
	collectionName: 'rocketchat_card_images',
});

FileUpload.configureUploadsStore('GridFS', 'GridFS:GroupImages', {
	collectionName: 'rocketchat_group_images',
});
