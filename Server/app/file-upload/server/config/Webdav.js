...
const WebdavCardImages = new FileUploadClass({
	name: 'Webdav:CardImages',
	get,
	copy,
	// store setted bellow
});

const WebdavGroupImages = new FileUploadClass({
	name: 'Webdav:GroupImages',
	get,
	copy,
	// store setted bellow
});
...
const configure = _.debounce(function() {
	...
	WebdavCardImages.store = FileUpload.configureUploadsStore('Webdav', WebdavCardImages.name, config);
	WebdavGroupImages.store = FileUpload.configureUploadsStore('Webdav', WebdavGroupImages.name, config);
