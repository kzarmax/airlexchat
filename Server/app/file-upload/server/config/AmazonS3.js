...
const AmazonS3CardImages = new FileUploadClass({
	name: 'AmazonS3:CardImages',
	get,
	copy,
	// store setted bellow
});

const AmazonS3GroupImages = new FileUploadClass({
	name: 'AmazonS3:GroupImages',
	get,
	copy,
	// store setted bellow
});
...
const configure = _.debounce(function() {
	...
	AmazonS3CardImages.store = FileUpload.configureUploadsStore('AmazonS3', AmazonS3CardImages.name, config);
	AmazonS3GroupImages.store = FileUpload.configureUploadsStore('AmazonS3', AmazonS3GroupImages.name, config);
